(function() {
  ...
  codeSegment.appendChild(code(0, 0, 'print("This is a really stupid long line of text frankly you should just pretend"'))
  codeSegment.appendChild(code(1, 0, 'print("This is a really stupid long line of text frankly you should just pretend"'))
  codeSegment.appendChild(code(2, 1, 'print("This is a really stupid long line of text frankly you should just pretend"'))
  codeSegment.appendChild(code(3, 2, 'print("This is a really stupid long line of text frankly you should just pretend"'))
  codeSegment.appendChild(code(4, 0, 'print("This is a really stupid long line of text frankly you should just pretend"'))
